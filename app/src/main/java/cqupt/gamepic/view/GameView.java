...
public class GameView extends GridLayout implements OnTouchListener {
     ...
     */
    private void animCreate(Item target) {
    ...
    private boolean checkSuperNum(int num) {
        boolean flag = (num == 2 || num == 4 || num == 8 || num == 16
                ...
                || num == 512 || num == 1024 || num == 2048 || num == 4096
                || num == 8192 || num == 16384 || num == 32768 || num == 65536);
        return flag;
    }
    ...
    private void initGameMatrix() {
        ...
        mGameMatrix = new Item[mGameLines][mGameLines];
    ...
    //检测所有数字 看是否有满足条件的 0:结束 pic1:正常 2:成功
